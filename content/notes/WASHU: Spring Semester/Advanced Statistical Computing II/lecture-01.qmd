...
math: true
summary: Defines optimization problems and key concepts (global/local minima, stationary points), and gives conditions—via lower semicontinuity, compactness, or coercivity—under which minimizers exist, with implications for statistical estimation and algorithms.
katex_macros:
